...
void Adafruit_INA219::setCalibration_16V_800mA(void) {
  
  // Calibration which uses the highest precision for 
  // current measurement (0.1mA), at the expense of 
  // only supporting 16V at 800mA max.
...
*/
/**************************************************************************/
int32_t Adafruit_INA219::getBusVoltage_mV() {
  int32_t value = getBusVoltage_raw();
  return value;
}
...
*/
/**************************************************************************/
int32_t Adafruit_INA219::getCurrent_100uA() {
  int32_t valueDec = 10*getCurrent_raw();
